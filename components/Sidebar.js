  ...
  return (
    ...
    <div className='max-h-screen flex flex-col'>
      ...
      <div className='flex flex-col md:flex-row flex-1'>
        ...
        <main className='main-content flex-1 ml-[188px] rounded-l-2xl rounded-r-2xl border-5 m-3 overflow-y-visible' style={{ background: 'linear-gradient(to bottom, #121212, #292929)' }}>
          {children}
        </main>
